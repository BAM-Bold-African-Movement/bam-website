      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-lg hover:transform hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">Blockchain Solutions</h3>
            <p className="text-gray-400">Custom blockchain development and integration for enterprise needs.</p>
          </div>
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-lg hover:transform hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">Security Services</h3>
